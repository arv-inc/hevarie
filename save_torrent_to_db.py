...
from webapp.get_rutracker_page import parse_search_result, get_rutracker_page, get_rutracker_session


RUTRACKER_LOGIN_URL = "https://rutracker.org/forum/login.php"
RUTRACKER_SEARCH_URL = "https://rutracker.org/forum/tracker.php?nm=War"
login = "hevarie"
password = "123456"
